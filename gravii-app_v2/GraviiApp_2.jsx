      ...
      {connected ? (
        <div style={{
          ...
          <div style={{ ...glassStyle(18), padding: "20px" }}>
            <span style={{ fontFamily: outfit, fontWeight: 700, fontSize: "15px", color: "rgba(0,0,0,0.55)", letterSpacing: "2px", display: "block", marginBottom: "12px" }}>YOUR GROUND</span>
            <span style={{ fontFamily: syne, fontWeight: 800, fontSize: "28px", color: t }}>{userChain}</span>
            <span style={{ fontFamily: outfit, fontWeight: 400, fontSize: "13px", color: "rgba(0,0,0,0.5)", display: "block", marginTop: "6px" }}>across {userChainCount} chains</span>
          </div>
          ...
          <div style={{ ...glassStyle(18), padding: "20px" }}>
            ...
            <span style={{ fontFamily: syne, fontWeight: 800, fontSize: "22px", color: t, display: "block", marginBottom: "4px" }}>{persona.name}</span>
            <span style={{ fontFamily: outfit, fontWeight: 700, fontSize: "14px", color: "rgba(0,0,0,0.5)" }}>{userStrength.pct}</span>
          </div>
          ...
          <div style={{ gridColumn: "1 / -1", display: "flex", gap: "14px" }}>
            ...
            <div
              ...
              style={{
                flex: 1, padding: "1.5px", cursor: "pointer",
                background: "linear-gradient(135deg, rgba(255,170,50,0.35), rgba(255,200,100,0.12), rgba(255,150,40,0.3))",
                borderRadius: "18px",
                transition: "opacity 0.3s ease",
              }}
              onMouseEnter={(e) => e.currentTarget.style.opacity = "0.85"}
            ...
            >
              <div style={{
                ...
                <span style={{ fontFamily: outfit, fontWeight: 700, fontSize: "15px", color: "rgba(200,130,40,0.7)", letterSpacing: "2px", display: "block", marginBottom: "8px" }}>X-RAY</span>
...
function MySpaceContent({ dark, connected, onConnect }) {
  ...
  const eligibleCampaigns = PARTNERS_DATA.flatMap(p =>
    p.campaigns.filter(c => c.eligible === true).map(c => ({ ...c, partner: p.name, partnerId: p.id }))
  );
  // Reach to Unlock 캠페인 (false, not ineligible)
  const reachCampaigns = PARTNERS_DATA.flatMap(p =>
    p.campaigns.filter(c => c.eligible === false).map(c => ({ ...c, partner: p.name, partnerId: p.id }))
  );
  ...
  return (
    <div>
      ...
      <div style={{ position: "relative" }}>
            ...
            {benefitsOpen && (filteredEligible.length === 0 ? (
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                {filteredEligible.map((c, i) => (
                  <div key={c.name + c.partner} style={{
                    display: "flex", justifyContent: "space-between", alignItems: "center",
                    padding: "20px 24px", border: `1px solid ${cardBorder}`, borderRadius: "12px",
                    background: cardBg, animation: `fadeInUp 0.5s ease ${0.6 + i * 0.08}s both`,
                  }}>
                    <div style={{ flex: 1 }}>
                      <span style={{ fontFamily: outfit, fontWeight: 700, fontSize: "16px", color: t, display: "block", marginBottom: "6px" }}>{c.name}</span>
                      <span style={{ fontFamily: outfit, fontWeight: 400, fontSize: "12px", color: sub, display: "block", marginBottom: "8px" }}>{c.partner}</span>
                      <div style={{ display: "flex", gap: "6px", flexWrap: "wrap" }}>
                        {(c.tags || []).map((tag, ti) => <SharedTagChip key={ti} tag={tag} />)}
                      </div>
                    </div>
                    <span style={{
                      fontFamily: outfit, fontWeight: 700, fontSize: "11px", color: "#1A1A1A", letterSpacing: "2px",
                      padding: "10px 20px", background: "rgba(100,200,130,0.8)", borderRadius: "8px",
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                {filteredReach.map((c, i) => (
                  <div key={c.name + c.partner} style={{
                    display: "flex", justifyContent: "space-between", alignItems: "center",
                    padding: "20px 24px", border: `1px solid ${cardBorder}`, borderRadius: "12px",
                    background: cardBg, opacity: 0.75, animation: `fadeInUp 0.5s ease ${0.85 + i * 0.08}s both`,
                  }}>
                    <div style={{ flex: 1 }}>
                      <span style={{ fontFamily: outfit, fontWeight: 700, fontSize: "16px", color: t, display: "block", marginBottom: "6px" }}>{c.name}</span>
                      <span style={{ fontFamily: outfit, fontWeight: 400, fontSize: "12px", color: sub, display: "block", marginBottom: "8px" }}>{c.partner}</span>
                    ...
                    <span style={{
                      fontFamily: outfit, fontWeight: 700, fontSize: "11px", color: "rgba(255,200,80,0.9)", letterSpacing: "2px",
                      padding: "10px 20px", border: "1px solid rgba(255,200,80,0.3)", borderRadius: "8px",
                      cursor: "pointer", whiteSpace: "nowrap", marginLeft: "16px",
                    }}>HOW TO QUALIFY →</span>
                  </div>
                ))}
        ...
        {!connected && (
          <div onClick={(e) => { e.stopPropagation(); onConnect(); }} style={{ position: "absolute", inset: 0, display: "flex", alignItems: "flex-start", justifyContent: "center", paddingTop: "40px", cursor: "pointer" }}>
            <div style={{
              padding: "16px 32px",
...
const PARTNERS_DATA = [
  {
    ...
    campaigns: [
      { name: "Yield Booster", category: "Wealth & Finance", period: "Jan 30 – Mar 1, 2026", eligible: true, desc: "Prestige rewards for verified value. We've matched your Architect profile with this exclusive Yield Booster. Secure your spot with a single click.",
        tags: [{ persona: "Smart Saver", type: "verified" }, { persona: "Profit Hunter", type: "verified" }, { tier: "Architect+", type: "tier" }] },
      { name: "ICO Allocation", category: "Exclusive Privileges", period: "Jan 30 – Mar 1, 2026", eligible: false, desc: "Exclusive allocation round for Visionary-tier members.",
        tags: [{ persona: "Strategic Holder", type: "requires" }, { tier: "Visionary", type: "tier" }],
        qualifySteps: ["Achieve the Strategic Holder persona by maintaining core assets long-term", "Reach the Visionary membership tier", "Maintain tier status for at least 7 consecutive days"] },
    ],
  },
  {
    ...
    campaigns: [
      { name: "Premium Lending Drop", category: "Wealth & Finance", period: "Feb 15 – Apr 30, 2026", eligible: false, desc: "This campaign requires the Wealth Guard persona. Maintain significant stable reserves to qualify.",
        tags: [{ persona: "Wealth Guard", type: "requires" }, { persona: "Cash Manager", type: "requires" }, { tier: "Builder+", type: "tier" }],
        qualifySteps: ["Maintain $50,000+ in stable reserves across supported chains", "Hold stablecoins for 30+ consecutive days", "Reach Builder tier or above on your Gravii ID"] },
    ],
  },
  {
    ...
    campaigns: [
      { name: "Lifestyle Rewards", category: "Lifestyle & Retail", period: "Opens Mar 15, 2026", eligible: null, desc: "Details will be revealed when the campaign goes live. Stay tuned.",
  ...
  },
  {
    ...
    campaigns: [
      { name: "Collector's Access", category: "Exclusive Privileges", period: "Ongoing", eligible: false, desc: "This privilege is reserved for users with the NFT Collector persona. Invitations are issued based on on-chain collection activity.",
        tags: [{ persona: "NFT Collector", type: "targeting" }, { tier: "Builder+", type: "tier" }],
        qualifySteps: ["Build the NFT Collector persona by trading and collecting NFTs at scale", "Reach Builder tier or above", "Maintain active collection activity for 14+ days"] },
      { name: "Collector's Circle", category: "Exclusive Privileges", period: "Ongoing", eligible: false, desc: "Inner circle access for top-tier collectors.",
        tags: [{ persona: "NFT Collector", type: "targeting" }, { persona: "Power User", type: "targeting" }, { tier: "Architect+", type: "tier" }],
        qualifySteps: ["Achieve both NFT Collector and Power User personas", "Reach Architect tier or above", "Be in the top 1,000 collectors on Standing"] },
      { name: "Early Mint Pass", category: "Hidden Gems", period: "Apr 1 – Apr 30, 2026", eligible: false, desc: "Priority minting access for upcoming partner drops.",
  ...
  },
  {
    ...
    campaigns: [
      { name: "Trading Fee Rebate", category: "Wealth & Finance", period: "Feb 1 – May 31, 2026", eligible: true, desc: "Earn back a percentage of your trading fees based on your monthly volume. Verified Active Traders get priority access.",
        tags: [{ persona: "Active Trader", type: "verified" }, { persona: "Swing Trader", type: "verified" }, { tier: "Explorer+", type: "tier" }] },
      { name: "VIP Desk Access", category: "Exclusive Privileges", period: "Ongoing", eligible: true, desc: "Direct access to a dedicated trading desk with premium execution and priority support.",
        tags: [{ persona: "Active Trader", type: "verified" }, { tier: "Architect+", type: "tier" }] },
    ],
  },
  {
    ...
    campaigns: [
      { name: "Community Airdrop", category: "Hidden Gems", period: "Mar 1 – Mar 31, 2026", eligible: true, desc: "A surprise token distribution for all active Gravii members. No strings attached — just show up.",
        tags: [{ tier: "All Tiers", type: "open" }] },
    ],
  },
  {
    ...
    campaigns: [
      { name: "Private Round Access", category: "Wealth & Finance", period: "Apr 1 – Jun 30, 2026", eligible: false, desc: "Early-stage investment allocation reserved for Major Investor persona holders with significant on-chain capital commitment.",
        tags: [{ persona: "Major Investor", type: "requires" }, { persona: "Wealth Guard", type: "requires" }, { tier: "Visionary", type: "tier" }],
        qualifySteps: ["Commit significant capital to high-cap assets to build market trust", "Maintain Wealth Guard-level stable reserves", "Achieve Visionary membership tier"] },
      { name: "Luxury Travel Package", category: "Lifestyle & Retail", period: "May 1 – Jul 31, 2026", eligible: false, desc: "Exclusive travel packages and premium hospitality experiences for top-tier members.",
        tags: [{ persona: "Major Investor", type: "requires" }, { tier: "Architect+", type: "tier" }],
        qualifySteps: ["Achieve the Major Investor persona", "Reach Architect tier or above", "Maintain tier for at least 14 days"] },
    ],
  },
  {
    ...
    campaigns: [
      { name: "Growth Accelerator", category: "Hidden Gems", period: "Apr 15 – May 31, 2026", eligible: "ineligible", desc: "This campaign is strictly limited to users who meet the exact persona and tier requirements. No alternative path to entry.",
        tags: [{ persona: "Rising Star", type: "targeting" }, { persona: "New Voyager", type: "targeting" }, { tier: "Explorer+", type: "tier" }] },
    ],
  },
];
    ...
    return (
      <div>
        ...
        <span
          ...
          style={{ fontFamily: outfit, fontWeight: 700, fontSize: "13px", color: sub, letterSpacing: "2px", cursor: "pointer", display: "inline-block", marginBottom: "28px", animation: "fadeInUp 0.4s ease both" }}
          ...
          {p.campaigns.map((c, i) => {
            ...
            <div
              ...
              style={{
                ...
                background: c.eligible === false ? "rgba(255,255,255,0.02)" : "rgba(255,255,255,0.04)",
                animation: `fadeInUp 0.5s ease ${0.25 + i * 0.1}s both`,
                cursor: "pointer",
                transition: "background 0.2s ease",
              }}
              onMouseEnter={(e) => e.currentTarget.style.background = "rgba(255,255,255,0.06)"}
              onMouseLeave={(e) => e.currentTarget.style.background = c.eligible === false ? "rgba(255,255,255,0.02)" : "rgba(255,255,255,0.04)"}
            >
              {/* Row 1: 이름 + 상태 */}
              ...
              <div style={{ display: "flex", gap: "16px", marginBottom: "10px", flexWrap: "wrap", alignItems: "center" }}>
                <span style={{ fontFamily: outfit, fontWeight: 400, fontSize: "13px", color: "rgba(255,255,255,0.35)" }}>Category: <span style={{ color: "rgba(255,255,255,0.55)" }}>{c.category}</span></span>
              ...
              {/* Row 3: expand/close — 독립 줄 */}
              <div style={{ textAlign: "center", paddingTop: "6px" }}>
                <span style={{
                  fontFamily: outfit, fontWeight: 700, fontSize: "13px", color: "rgba(230,220,250,0.5)",
                  letterSpacing: "1.5px",
                          ...
                          <div style={{ marginBottom: "20px", padding: "16px 20px", background: "rgba(255,255,255,0.03)", borderRadius: "8px", border: "1px solid rgba(255,255,255,0.06)" }}>
                            ...
                            <div style={{ display: "flex", gap: "24px", flexWrap: "wrap" }}>
                              ...
                              <div>
                                ...
                                <span style={{ fontFamily: outfit, fontWeight: 700, fontSize: "14px", color: t }}>Architect</span>
                              </div>
                            </div>
                          </div>
        ...
        <div
          ...
          style={{
            ...
            cursor: "pointer", animation: "fadeInUp 0.5s ease 0.6s both",
            transition: "background 0.2s ease",
          }}
          onMouseEnter={(e) => e.currentTarget.style.background = "rgba(255,255,255,0.04)"}
          onMouseLeave={(e) => e.currentTarget.style.background = "transparent"}
        >
          <span style={{ fontFamily: outfit, fontWeight: 700, fontSize: "11px", color: sub, letterSpacing: "2px" }}>FIND DIFFERENT CAMPAIGNS ←</span>
        </div>
      </div>
    );
  }
        ...
        <div style={{
          ...
          <input
            ...
            style={{
              ...
              fontFamily: outfit, fontSize: "10px", color: t, letterSpacing: "0.5px",
              width: "70px",
            }}
          />
        </div>
          ...
          {filteredPartners.map((p) => (
            ...
            >
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "10px" }}>
                <span style={{ fontFamily: outfit, fontWeight: 700, fontSize: "18px", color: t }}>{p.name}</span>
              ...
              <div style={{ marginBottom: "12px" }}>
                <span style={{ fontFamily: outfit, fontWeight: 400, fontSize: "13px", color: sub }}>{p.campaigns.length} campaign{p.campaigns.length > 1 ? "s" : ""}</span>
              </div>
              {/* Row 3: 대표 태그 chips */}
              {(() => {
...
function LeaderboardContent({ dark, connected, onConnect }) {
  ...
  return (
    <div>
      ...
      <p style={{ fontFamily: outfit, fontWeight: 400, fontSize: "17px", color: sub, lineHeight: 1.7, marginBottom: "32px", animation: "fadeInUp 0.5s ease 0.3s both" }}>Real-time behavioral rankings updated daily.</p>
      <div style={{ padding: "28px 32px", borderRadius: "14px", border: connected ? `1px solid ${cardBorder}` : `1px dashed ${cardBorder}`, background: cardBg, marginBottom: "32px", animation: "fadeInUp 0.5s ease 0.35s both" }}>
        {connected ? (
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "24px" }}>
            <div><span style={{ fontFamily: outfit, fontWeight: 700, fontSize: "14px", color: sub, letterSpacing: "2px", display: "block", marginBottom: "10px" }}>YOU</span><span style={{ fontFamily: syne, fontWeight: 800, fontSize: "36px", color: t }}>Messi</span></div>
            <div><span style={{ fontFamily: outfit, fontWeight: 700, fontSize: "14px", color: sub, letterSpacing: "2px", display: "block", marginBottom: "10px" }}>TOP CATEGORY</span><span style={{ fontFamily: outfit, fontWeight: 700, fontSize: "22px", color: "rgba(230,220,250,0.8)" }}>Power User</span></div>
            <div><span style={{ fontFamily: outfit, fontWeight: 700, fontSize: "14px", color: sub, letterSpacing: "2px", display: "block", marginBottom: "10px" }}>LABELS</span><span style={{ fontFamily: outfit, fontWeight: 400, fontSize: "16px", color: "rgba(255,255,255,0.6)" }}>Strategic Holder, Profit Hunter, Chain Hopper</span></div>
          </div>
        ) : (
          <div onClick={(e) => { e.stopPropagation(); onConnect(); }} style={{ textAlign: "center", cursor: "pointer", padding: "20px 0" }}>
            <p style={{ fontFamily: outfit, fontWeight: 700, fontSize: "14px", color: sub, letterSpacing: "3px" }}>SIGN IN TO SEE YOUR RANK</p>
          </div>
        )}
      </div>
      <div style={{ display: "flex", gap: "8px", flexWrap: "wrap", marginBottom: "28px", animation: "fadeInUp 0.5s ease 0.4s both" }}>
        {["Top Movers", "Power Users", "High Volume", "Rising Stars", "Trendsetters", "Most Active"].map((cat, i) => (
          <span key={cat} style={{ fontFamily: outfit, fontWeight: 700, fontSize: "13px", color: i === 0 ? "#1A1A1A" : sub, background: i === 0 ? "rgba(230,220,250,0.8)" : (dark ? "rgba(255,255,255,0.06)" : "rgba(0,0,0,0.04)"), padding: "9px 18px", borderRadius: "6px", letterSpacing: "1px", cursor: "pointer" }}>{cat}</span>
        ))}
      </div>
      <div style={{ animation: "fadeInUp 0.5s ease 0.45s both" }}>
        ...
        {connected && (
          <div style={{ display: "grid", gridTemplateColumns: "80px 100px 1fr 1fr 90px", gap: "8px", padding: "18px 24px", marginBottom: "8px", border: "1px solid rgba(230,220,250,0.3)", borderRadius: "12px", background: "rgba(230,220,250,0.06)" }}>
            <span style={{ fontFamily: syne, fontWeight: 800, fontSize: "22px", color: "rgba(230,220,250,0.8)" }}>56K</span>
            <span style={{ fontFamily: outfit, fontWeight: 700, fontSize: "15px", color: "rgba(230,220,250,0.8)" }}>Gold</span>
            ...
            <span style={{ fontFamily: syne, fontWeight: 800, fontSize: "18px", color: "rgba(100,200,100,0.8)" }}>—</span>
          </div>
        )}
        <div>
          {[{ rank: "1", tier: "Diamond", name: "Benji", id: "xxx...sfxx", change: "+1", up: true }, { rank: "2", tier: "Diamond", name: "Diddy", id: "xxx...pxxx", change: "-1", up: false }, { rank: "3", tier: "Platinum", name: "Satoshi", id: "xxx...a1b2", change: "+3", up: true }].map(r => (
            <div key={r.rank} style={{ display: "grid", gridTemplateColumns: "80px 100px 1fr 1fr 90px", gap: "8px", padding: "18px 24px", marginBottom: "8px", border: `1px solid ${cardBorder}`, borderRadius: "12px" }}>
              <span style={{ fontFamily: syne, fontWeight: 800, fontSize: "22px", color: t }}>{r.rank}</span>
              <span style={{ fontFamily: outfit, fontWeight: 700, fontSize: "15px", color: sub }}>{r.tier}</span>
              ...
              <span style={{ fontFamily: syne, fontWeight: 800, fontSize: "18px", color: r.up ? "rgba(100,200,100,0.8)" : "rgba(200,100,100,0.8)" }}>{r.change}</span>
            </div>
          ))}
        </div>
      </div>
